...
namespace CertifyKit
{
    public class Program
    {
        public static void FileExecute(string commandName, Dictionary<string, string> parsedArgs)
        {
            ...
            //change from outfile to log. reverved outfile flag for other usage
            var file = parsedArgs["/log"];
        ...
        public static void MainExecute(string commandName, Dictionary<string, string> parsedArgs)
        {
            ...
            {
                Console.WriteLine("\r\n[!] Unhandled CertifyKit exception:\r\n");
                Console.WriteLine(e);
            }

            sw.Stop();
            if(!parsedArgs.ContainsKey("/json"))
                Console.WriteLine("\r\n\r\nCertifyKit completed in " + sw.Elapsed);
        }
        ...
        public static void Main(string[] args)
        {
            try
            {
                ...
                //change from outfile to log. reverved outfile flag for other usage
                if (parsed.Arguments.ContainsKey("/log"))
                {
